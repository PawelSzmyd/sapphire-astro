...
export const residences: Residence[] = [
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/assets/gallery-vega/vega-kitchen-dining-2.webp", alt: "Jadalnia z widokiem na telewizor wyświetlający zachód słońca", caption: "Jadalnia" },
      { src: "/assets/gallery-vega/vega-tv-sunset.webp", alt: "Salon z telewizorem wyświetlającym zachód słońca nad morzem", caption: "Salon" },
      { src: "/assets/gallery-vega/vega-living-night.webp", alt: "Salon nocą z widokiem na oświetlone miasto", caption: "Salon nocą" },
      { src: "/assets/gallery-vega/vega-pool-sunset.webp", alt: "Basen na tarasie o zachodzie słońca", caption: "Basen" },
      { src: "/assets/gallery-vega/vega-welcome-card.webp", alt: "Powitalna karta SAPPHIRE Apartments na tarasie", caption: "Powitanie SAPPHIRE" },
      { src: "/assets/gallery-vega/vega-brand-fabric.webp", alt: "Sygnatura SAPPHIRE Apartments wyszyta na tkaninie", caption: "Detal marki" },
    ],
